...
description: Managing package upgrades, resolving peer conflicts, and auditing dev dependencies.
---

# Dependency Management

## Purpose & Scope
Auditing packages and dependencies.

## Checklists
- [ ] Run 
pm audit weekly to catch security vulnerabilities.
- [ ] Keep package.json dependencies minimal.

## Decision Tree
`
Need to work on dependency-management?
