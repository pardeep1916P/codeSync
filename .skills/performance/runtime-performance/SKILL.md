...
description: Runtime performance standards, async throttling, and UI responsiveness benchmarks for the React dashboard.
---
...
## Checklists
- [ ] Check CPU usage of background workers.

## Decision Tree
`
Need to work on runtime-performance?
