...
description: Inspecting intercepted network calls, reading payload bodies, and debugging CORS/redirect errors in CodeSync.
---

# Network Debugging

## Purpose & Scope
Debugging LeetCode network calls.

## Checklists
- [ ] Inspect payloads via Network tab.

## Decision Tree
`
Need to work on network-debugging?
