---
name: error-recovery
description: Recovering from service worker crashes, storage corruption, network timeouts, and token expirations in CodeSync.
---
...
## Checklists
- [ ] Log errors to storage for inspection.
