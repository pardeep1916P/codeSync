...
description: Versioning policies, semantic numbering, manifest updates, and git tags.
---
...
## Checklists
- [ ] Match versions in manifest.json and package.json.

## Decision Tree
`
Need to work on versioning-strategy?
