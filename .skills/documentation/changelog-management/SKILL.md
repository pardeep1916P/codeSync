...
description: Standardizing CHANGELOG.md formatting, tracking version history, and logging bug fixes and releases.
---
...
## Checklists
- [ ] Add entries under a clear header date.
- [ ] Follow Keep a Changelog conventions.

## Decision Tree
`
Need to work on changelog-management?
