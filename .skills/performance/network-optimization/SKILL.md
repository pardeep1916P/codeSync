...
description: Network optimization policies, API payload size reduction, and GitHub client connection management in CodeSync.
---
...
## Decision Tree
`
Need to work on network-optimization?
