...
description: Writing clear architecture documentation and specifications for modules, message passing, and network interceptors.
---
...
## Checklists
- [ ] Document new message types and action schemas.

## Decision Tree
`
Need to work on architecture-docs?
