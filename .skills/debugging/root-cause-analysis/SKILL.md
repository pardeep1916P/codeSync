...
description: Debugging methodologies, console error analysis, stack trace inspection, and error root-cause identification.
---

# Root Cause Analysis

## Purpose & Scope
Solving extension exceptions.

## Checklists
- [ ] Analyze full console stack traces.

## Decision Tree
`
Need to work on root-cause-analysis?
