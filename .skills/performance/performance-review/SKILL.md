...
description: Performance review practices, measuring loading speed, and optimizing resource usage in CodeSync.
---

# Performance Review

## Purpose & Scope
Extension speed metrics.

## Checklists
- [ ] Audit popup load times.

## Decision Tree
`
Need to work on performance-review?
