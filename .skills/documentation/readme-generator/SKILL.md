...
description: Generating and maintaining comprehensive project README files detailing features, configurations, and scripts.
---

# README Generator

## Purpose & Scope
Root README documentation formatting rules.

## Checklists
- [ ] Root README updated dynamically during sync.

## Decision Tree
`
Need to work on readme-generator?
