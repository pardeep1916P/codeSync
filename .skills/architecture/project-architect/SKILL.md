...
description: Project architecture plans, directory layout rules, boundary definition, and module dependencies.
---

# Project Architect

## Purpose & Scope
Outlines directory structures, boundaries, and separation of concerns inside CodeSync.

## Checklists
- [ ] Keep source directory (src/) structured clearly by boundaries.
- [ ] Avoid circular imports between background and queue modules.

## Decision Tree
`
Need to work on project-architect?
