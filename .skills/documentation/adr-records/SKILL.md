---
name: adr-records
description: Documenting Architectural Decision Records (ADRs) to track structural choices and implementation trade-offs.
---
...
## Checklists
- [ ] Record context, options, decision, and consequences.

## Decision Tree
`
Need to work on adr-records?
