...
description: Integration testing patterns for testing Chrome extension components together — content script + background + storage interactions.
---

# $args[0].Value.ToUpper()ntegration$args[0].Value.ToUpper()esting

## Purpose & Scope

Integration testing patterns for testing Chrome extension components together — content script + background + storage interactions.
